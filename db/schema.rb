...
ActiveRecord::Schema.define(version: 20150419224702) do
  ...
  add_index "favorites", ["user_id", "restaurant_id"], name: "index_favorites_on_user_id_and_restaurant_id", unique: true
